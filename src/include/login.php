...
$welcome_text = file_get_contents('https://infomikhmon.santaitivi.my.id/welcome_text.txt');
...
<div style="padding-top: 5%;" class="login-box">
        <div class="card">
            <div class="card-header">
                <h3 style="display: flex; align-items: center; justify-content: center; height: 25px; gap: 10px;">Inbox :
    ...
    <div class="card-body">
      <div class="text-center pd-5">
        <img src="img/logo2.png" alt="MIKHMON Logo">
      </div>
      <div  class="text-center">
      <span style="font-size: 24px; margin: 10px; font-weight:bolder; color: #fcc40d;">SKYMON MANAGEMENT</span><br>
            <b style="font-size:16px;font-weight:bolder; display: block; margin-bottom: 15px;"> <?= $format_tanggal; ?> </b>
      <center>
